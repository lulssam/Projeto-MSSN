...
public class ProjectileManager {
    ...
    /**Método para escolher direção, velocidade e cor do projetil
     * @param origin Inimigo
     * @param velocity velocidade do projetil
     * @param color cor do projétil*/
    public void spawnCustomEnenmyShot(PVector origin, PVector velocity, int color) {
